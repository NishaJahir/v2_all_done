...
class PaymentService
{
    ...
    {
        return (bool) ($this->settingsService->getPaymentSettingsValue('novalnet_public_key') != '' && $this->settingsService->getPaymentSettingsValue('novalnet_private_key') != '' && $this->settingsService->getPaymentSettingsValue('novalnet_tariff_id') != '');
    }
    ...
    public function getPaymentData(&$paymentRequestData, $paymentKey)
    {
        ...
        if(in_array($paymentKey, ['NOVALNET_SEPA', 'NOVALNET_INVOICE', 'NOVALNET_PREPAYMENT', 'NOVALNET_GUARANTEED_SEPA', 'NOVALNETS_CASHPAYMENT'])) {
    ...
    public function additionalPaymentInfo($paymentResponseData)
    {
        ...
        if($paymentResponseData['result']['status'] == 'SUCCESS') {
            ...
            if(in_array($paymentResponseData['payment_method'], ['novalnet_invoice', 'novalnet_prepayment'])) {
